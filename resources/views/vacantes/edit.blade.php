...
<form action="{{ route('vacantes.store')}}" method="POST" class="max-w-lg mx-auto my-10">
    ...
    <div class="mb-5">
        ...
        <input type="text" id="titulo" name="titulo" class="p-3 bg-gray-100 rounded form-input w-full" placeholder="Título de la vacante" value="{{ old('titulo')}}">
        ...
        >
            ...
            @foreach ($salarios as $salario)
                <option
                    ...
                    value="{{$salario->id}}">{{$salario->name}}</option>
            @endforeach
        </select>
    ...
    <div class="mb-5">
        <label for="imagen" class="block text-gray-700 text-sm mb-2">Habilidades y Conocimientos: <span class="text-xs mb-5">(Elige al menos 2)</span> </label>
        @php
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        //Agrega al input hidden lo que el usuario escrube en medium editor
        ...
        const dropzoneDevJobs = new Dropzone('#dropzoneDevJobs', {
            url: "/vacantes/imagen",
            dictDefaultMessage: 'Suber aqui tu archivo',
