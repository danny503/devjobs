...
@section('content')
    ...
    <div class="mt-10 mb-20 md:flex items-start">
        <div class="md:w-3/5">
            ...
            <p class="block text-gray-700 font-bold my-2">
                Categoria: <span class="font-normal">{{$vacante->categoria->name}}</span>
            </p>
            <p class="block text-gray-700 font-bold my-2">
                Salario: <span class="font-normal">{{$vacante->salario->name}}</span>
            </p>
            <p class="block text-gray-700 font-bold my-2">
                Ubicación: <span class="font-normal">{{$vacante->ubicacion->name}}</span>
            </p>
            <p class="block text-gray-700 font-bold my-2">
                Experiencia: <span class="font-normal">{{$vacante->experiencia->name}}</span>
            </p>

            <h2 class="text-2xl text-center mt-10 mb-5 text-gray-700">Conocimientos y Tecnologías</h2>
