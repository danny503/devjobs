            ...
            <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-5" method="POST" action="{{ route('password.update') }}" novalidate>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password" type="password" class="p-3 bg-gray-200 rounded form-input w-full @error('password') boder-red-500 border @enderror" name="password" required autocomplete="new-password">
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password-confirm" type="password" class="p-3 bg-gray-200 rounded form-input w-full"
