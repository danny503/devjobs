    ...
    <div class="flex flex-col lg:flex-row shadow bg-white">
        <div class="lg:w-1/2 px-8 lg:px-12 py-12 lg:py-24">
            ...
            <h1 class="mt-2 sm:mt-4 text-3xl font-bold text-gray-700 leading-tight">
                ...
                <span class="text-teal-500 block">Para desrrolladores y diseñadores</span>
            </h1>
            @include('ui.buscar')
        </div>
        <div class="block lg:w-1/2">
            <img class="inset-0 h-full w-full object-cover" src="/img/pg.jpg" alt="devjobjs">
        </div>
    </div>

    <div class="my-10 bg-gray-100 p-10 shadow">
        <h1 class="text-3xl text-gray-700 m-0">Nuevas
