...
@section('content')
    <h1 class="text-2xl text-center mt-10">Cadidatos {{$vacante->titulo}} </h1>
    ...
    @if (count($vacante->candidatos) > 0)
        <ul class="max-w-md mx-auto mt-10">
            ...
            <li class="p-5 border border-gray-400 mb-5">
                ...
                <a target="blank" class="bg-teal-500 p-3 inline-block text-xs font-bold uppercase text-white" href="/storage/cv/{{$candidato->cv}}">Ver CV</a>
            </li>
